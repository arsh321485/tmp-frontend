              ...
              <div class="right-card w-100">
                ...
                <div class="d-flex">
                  <button class="btn btn-outline-dark btn-sm me-2" type="button" @click="signup('slack')">
                    <span class="btn-text " style="font-size: smaller;">Sign up with Slack</span>
                  </button>
                  <button class="btn btn-outline-dark btn-sm me-2" type="button" @click="signup('teams')">
                    <span class="btn-text" style="font-size: smaller;">Sign up with Teams</span>
                  </button>
                  <button class="btn btn-outline-dark btn-sm" type="button" @click="signup('asana')">
                    <span class="btn-text" style="font-size: smaller;">Sign up with Asana</span>
                  </button>
                </div>
                <!-- ===== End CTA Buttons ===== -->
