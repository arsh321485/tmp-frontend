            ...
            <aside class="col-12 col-lg-6 left-image-panel d-none d-lg-block">
              <div class="left-image-wrapper">
                ...
                <div class="left-overlay-text">
                  <h1 class="overlay-title ">Get Started</h1>
...
export default defineComponent({
  ...
  methods: {
    // typed `this` for Options API methods
    isSelected(this: { selectedDomains: string[] }, val: string): boolean {
      return this.selectedDomains.includes(val);
    },

    toggle(this: { selectedDomains: string[]; domainOptions: DomainOption[] }, val: string): void {
      if (val === "all") {
        ...
        // keep "all" consistent with other picks
        const nonAll = this.domainOptions.filter((o: DomainOption) => o.value !== "all").map(o => o.value);
